...
public class MonsterFactory {
    ...
    private Hashtable<String, Array<MonsterEntityType>> monsterZones;
    ...
    private MonsterFactory(){
        ...
        entities =  Entity.initEntities(configs);
    ...
    public Entity getRandomMonster(int monsterZoneID){
        Array<MonsterEntityType> monsters = monsterZones.get(String.valueOf(monsterZoneID));
    ...
    public Entity getMonster(MonsterEntityType monsterEntityType){
        Entity entity = entities.get(monsterEntityType.toString());
