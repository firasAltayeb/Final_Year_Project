...
public class OldMainGameScreen implements Screen {

    private static final String TAG = OldMainGameScreen.class.getSimpleName();
    ...
    public void render(float delta) {
        ...
        mapRenderer.getBatch().draw(currentPlayerFrame, currentPlayerSprite.getX(), currentPlayerSprite.getY(),1.2f, 2);
